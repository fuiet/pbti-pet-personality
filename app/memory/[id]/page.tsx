    ...
    <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6">
      ...
      <div className="mt-8 rounded-3xl border border-[#eaded2] bg-white p-6 shadow-sm">
        ...
        <p className="mt-3 text-sm leading-7 text-[#655a51]">
          {pet.name ? pet.name : "Your pet"}&apos;s journey is a beautiful story of trust, discovery, and 
          companionship. Every moment together adds a new chapter to this unique bond.
        </p>
      </div>
      ...
      <div className="mt-8 rounded-3xl border-2 border-dashed border-[#eaded2] p-8 text-center">
        ...
        <p className="mt-1 text-sm text-[#7a6d63]">
          Upload photos and create a rich timeline of your pet&apos;s life
        </p>
        <button
