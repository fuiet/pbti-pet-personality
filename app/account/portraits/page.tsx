...
function groupSubtitle(kind: PortraitGroup["key"], zh: boolean) {
  if (kind === "avatar") return zh ? "适合封面、头像与分享卡使用。" : "Best for covers, avatars, and share cards.";
  if (kind === "landscape") return zh ? "更适合横向海报与宽幅展示。" : "Better suited to wide posters and horizontal layouts.";
      ...
      <section className="relative overflow-hidden rounded-[2.2rem] bg-[#171514] px-8 py-10 text-white shadow-[0_28px_80px_rgba(52,34,20,.18)]">
        ...
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <div className="text-xs font-black uppercase tracking-[.18em] text-[#ffb878]">{zh ? "写真海报" : "Portrait posters"}</div>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/account" className="rounded-full border border-white/14 bg-white/8 px-5 py-3 text-sm font-black text-white transition hover:bg-white/14">
