-- Run this in Supabase SQL Editor to allow signed-in users to save and read their own PBTI data.
...
alter table public.pets alter column age type text using age::text;
